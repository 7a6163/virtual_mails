RSpec.describe VirtualMails::Email do
  ...
  describe ".clear" do
    after { Email.clear }
    it { expect(Rails.cache).to receive(:delete).with(VirtualMails::CacheKey) }
  end
  ...
  describe ".all" do
    ...
    context "with cache" do
      ...
      before { allow(Rails.cache).to receive(:fetch).with(VirtualMails::CacheKey).and_return(emails) }
